...
> **🚀 はじめての方へ（最短ルート）**
> 1. [Module 0：なぜ確率が必要か](notes/00_why_probability.md) を読む（「平均で計画する罠」を数値で体感）。
> 2. [学習地図](roadmap/learning_map.md) で全体像と依存関係をつかむ。
> 3. 到達点の [6形式コンパレータ](apps/stochastic_optimization_comparator/README.md) で、**同じ問題の最適決定が形式により 100〜137 と変わる**ことを確かめる。
>
