...
>
> 1. **[🧭 確率の使い方（実践ガイド）](notes/how_to_use_probability.md)**（10分）
>    — 確率を使う＝**①名付ける→②表す→③決める**の3ステップ。パン屋の例（何個焼く?）で最後までやり切り、**自分の問題に当てはめるテンプレート**まで。
...
>
> **インストール不要**：5本のインタラクティブツールは[ブラウザでそのまま動きます](interactive/index.md)。
